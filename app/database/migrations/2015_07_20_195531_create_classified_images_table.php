...
class CreateClassifiedImagesTable extends Migration {
	...
	public function up()
	{
		Schema::create('classified_images', function(Blueprint $table)
		{
            ...
            $table->string('title_image_name', 255);
            $table->string('body_image1_name', 255);
            $table->string('body_image2_name', 255);
            $table->string('body_image3_name', 255);
            $table->string('body_image4_name', 255);
			$table->timestamps();
		});
	}
